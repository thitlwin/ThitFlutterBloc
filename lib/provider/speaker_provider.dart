...
//   Future saveNoteToDB(Speaker speaker) async {
//     try {
//       final db = await dbProvider.database;
//       var res = db.insert(TableProvider.speakerTable, speaker.toJson());
//       return res;
//     } catch (e, stackTrace) {
//       developer.log("Saved Error", error: e, stackTrace: stackTrace);
//     }
...
//     try {
//       final db = await dbProvider.database;
//       var res = await db.query(TableProvider.speakerTable);
//       return res.map((it) => Speaker.fromJson(it)).toList();
//     } catch (e, stackTrace) {
...
class SpeakerProvider {
  ...
  //   return speakerCollection.doc(speaker.toString()).delete();
  // }

  // @override
  // Future<void> updateSpeaker(Speaker update) {
  //   return speakerCollection.doc(update.speaker).update(update.toDocument());
  // }
}
