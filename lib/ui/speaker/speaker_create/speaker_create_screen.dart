...
//     return BlocBuilder<SpeakerCreateBloc, SpeakerCreateState>(
//         cubit: widget._speakerCreateBloc,
//         builder: (
//           BuildContext context,
//           SpeakerCreateState currentState,
//         ) {
//           if (currentState is UnSpeakerCreateState) {
//             return Center(
//               child: CircularProgressIndicator(),
//             );
//           }
//           if (currentState is ErrorSpeakerCreateState) {
//             return Center(
//                 child: Column(
...
//             ));
//           }
//            if (currentState is InSpeakerCreateState) {
//             return Center(
//               child: Column(
//                 mainAxisAlignment: MainAxisAlignment.center,
//                 children: <Widget>[
